							...
							<div class="col-xl-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body pb-0">
										<div class="pb-3 border-bottom mb-3">
											<div class="d-flex mb-3 flex-wrap align-items-end">
												<img class="rounded mr-3"  src="{{ asset('images/customers/1.jpg') }}" width="58" alt="">
												<div>
										...
										<div class="pb-3 border-bottom mb-3">
											<div class="d-flex mb-3 flex-wrap align-items-end">
												<img class="rounded mr-3"  src="{{ asset('images/customers/2.jpg') }}" width="58" alt="">
												<div>
										...
										<div class="pb-3">
											<div class="d-flex mb-3 flex-wrap align-items-end">
												<img class="rounded mr-3"  src="{{ asset('images/customers/3.jpg') }}" width="58" alt="">
												<div>
									...
									<div class="card-footer border-0 p-0">
										<a href="{!! url('/review'); !!}" class="btn d-block btn-primary rounded">See More Reviews</a>
									</div>
								</div>
							</div>
							<div class="col-xl-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="testimonial-one owl-carousel">
											<div class="items">
												<a href="{!! url('/property-details'); !!}"><img  src="{{ asset('images/testimonial/1.png') }}" alt="#" class="w-100 mw-100 mb-3 rounded"></a>
												<h5 class="fs-16 font-w600 mb-0"><a href="{!! url('/property-details'); !!}" class="text-black">98AB Alexander Court, London</a></h5>
