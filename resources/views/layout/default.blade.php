    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
			...
			@else
                <img class="logo-abbr" src="{{ asset('images/petro-logo.png') }}" alt="">
			@endif
			@if(!empty($logoText))
                <img class="logo-compact" src="{{ asset($logoText) }}" alt="">
                <img class="brand-title" src="{{ asset($logoText) }}" alt="">
			@else
                <img class="logo-compact" src="{{ asset('images/petro-text.png') }}" alt="">
                <img class="brand-title" src="{{ asset('images/petro-text.png') }}" alt="">
			@endif	
            </a>
