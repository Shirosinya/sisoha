			...
			<div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Lap. Inventaris</a></li>
					</ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Lap. Inventaris</h4>
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Tambah Lap. Inventaris</h5>
                                                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                                    </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <h3 style="margin-top:-15px; margin-bottom:15px;" >REGU A</h3>
                                                                    <form id="form-create-giatarmada" name="form-create-giatarmada" method="POST" action="{{route('createinventaris')}}">
                                                                        @csrf
                                                                        <input type="hidden" name="regu_id" value="1">
                                                                        <div class="form-group row">
                                                                            <label class="col-sm-3 col-form-label">Barang</label>
                                                                            <div class="col-sm-9">
                                                                                <select required name="barang_id" class="form-control" id="barang_id">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-9">
                                                                                <input name="keterangan" type="text" class="form-control" placeholder="Keterangan opsional.."></input>
                                                                            </div>
                                                                        </div>
                                                                </div>
                                                                ...
                                                                <td>
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#editModal{{$inventaris->id}}">Edit</a>
                                                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#hapusModal{{$inventaris->id}}">Delete</a>
                                                                        </div>
                                                                    </div>
                                                                    <!-- MODAL UPDATE A -->
                                                                    <div class="modal fade bd-example-modal-lg" id="editModal{{$inventaris->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                                        <div class="modal-dialog modal-lg">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title">Edit Lap. Inventaris</h5>
                                                                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                                                    </button>
                                                                                </div>
                                                                                <div class="modal-body">
                                                                                    <h3 style="margin-top:-15px; margin-bottom:15px;" >REGU A</h3>
                                                                                    <form id="form-update-inventaris" name="form-update-inventaris" method="POST" action="/inventaris/{{$inventaris->id}}/update">
                                                                                    @csrf
                                                                                    <input type="hidden" name="regu_id" value="1">
                                                                                    <div class="form-group row">
                                                                                        <label class="col-sm-3 col-form-label">Barang</label>
                                                                                        <div class="col-sm-9">
                                                                                            <select required name="barang_id" class="form-control" id="barang_id">
                                                                                            @foreach($barangs as $barang)
                                                                                            <option value="{{$barang->id}}" {{$barang->id == $inventaris->barang_id ? 'selected' :''}}>{{$barang->nama_barang}}</option>
                                                                                            @endforeach
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group row">
                                                                                        ...
                                                                                        <div class="col-sm-9">
                                                                                            <select name="kondisi" class="form-control" id="kondisi">
                                                                                            <option value="Baik/Lengkap" {{$inventaris->kondisi == 'Baik/Lengkap' ? 'selected' : ''}}>Baik/Lengkap</option>
                                                                                            <option value="Rusak/Hilang" {{$inventaris->kondisi == 'Rusak/Hilang' ? 'selected' : ''}}>Rusak/Hilang</option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group row">
                                                                                        <label class="col-sm-3 col-form-label">Keterangan</label>
                                                                                        <div class="col-sm-9">
                                                                                            <input name="keterangan" value="{{$inventaris->keterangan}}" type="text" class="form-control" placeholder="Keterangan opsional.."></input>
                                                                                        </div>
                                                                                    </div>
                                                                            </div>
                                                                                    <div class="modal-footer">
                                                                    ...
                                                                    <!-- MODAL UPDATE A END -->
                                                                    <!--MODAL HAPUS A-->
                                                                    <div class="modal fade" id="hapusModal{{$inventaris->id}}">
                                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <form method="POST" action="/inventaris/{{$inventaris->id}}/destroy">
                                                                                    @csrf
                                                                                        <input type="hidden" name="regu_id" value="1">
