	...
	var dzMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#2b98d6', 'rgb(0, 158, 60)', '#37d159'],
				//responsive:true,
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				pointSize: 3,
				fillOpacity: 0,
				pointStrokeColors: ['#ff6746', '#37d159', '#2b98d6'],
				behaveLikeLine: true,
				gridLineColor: 'transparent',
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(0, 158, 60)', 'rgb(55, 209, 89)', '#2b98d6'],
				resize: true
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#2b98d6', 'rgb(16, 202, 147)', 'rgb(0, 158, 60)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
