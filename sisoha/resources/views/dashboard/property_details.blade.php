							...
							<div class="col-xl-12 col-lg-12">
								<div class="card text-center">
									<div class="card-body">
										...
										<h4 class="text-black fs-20 font-w600">Samuel Rodriguez</h4>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-body">
										...
										<div>
											<a href="javascript:void(0);" class="btn btn-primary rounded mb-4">Type XYZ</a>
											<div class="d-md-flex d-block mb-sm-5 mb-3">
												<div class="mr-auto mb-md-0 mb-4">
													<h2 class="font-w600 text-black">98AB Alexander Court, London</h2>
													<span class="fs-18">
												...
												<div class="ml-md-4 text-md-right">
													<p class="fs-14 text-black mb-1 mr-1">Price range</p>
													<h4 class="fs-24 text-primary">$400.000 - $600.000</h4>
												</div>
											</div>
