              ...
              <div class="col-xl-12">
                  <div class="auth-form">
                      <div class="text-center mb-3">
                        <img  src="{{ asset('images/petro-full.png') }}" alt="">
                      </div>
                      ...
                      <form method="POST" action="{{ route('login') }}">
                          ...
                          <div class="form-group">
                              ...
                              <input :value="old('nama')" required name="nama" type="text" class="form-control" placeholder="Masukkan Nama Pengguna">
                                @error('nama')
                          ...
                          <div class="form-group">
                              ...
                              <input required name="password" type="password" class="form-control" placeholder="Password" autocomplete="current-password">
                          </div>
